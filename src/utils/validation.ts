...
const firstName = yup.string().required('Input login').min(3, 'To short').max(50, 'To long');

const lastName = yup.string().required('Input login').min(3, 'To short').max(50, 'To long');
